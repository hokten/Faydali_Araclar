define('ember-moment/helpers/moment-subtract', ['exports', 'ember', 'moment', 'ember-moment/utils/helper-compute', 'ember-moment/helpers/-base'], function (exports, _ember, _moment, _emberMomentUtilsHelperCompute, _emberMomentHelpersBase) {
  'use strict';
  ...
  exports['default'] = _emberMomentHelpersBase['default'].extend({
    ...
    compute: (0, _emberMomentUtilsHelperCompute['default'])(function (params, _ref) {
      ...
      return (_morphMoment = this.morphMoment(_moment['default'].apply(undefined, args), { locale: locale, timeZone: timeZone })).subtract.apply(_morphMoment, subtractionArgs.concat([precision]));
    })
  });
});